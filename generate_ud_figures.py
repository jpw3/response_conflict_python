...
ax1.set_ylim(500,700); ax1.set_yticks(arange(550,701,50)); ax1.set_xlim([0.7,1.9]); ax1.set_xticks([1,1.6]); ax1.set_title('Bottom Up Task, UP Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax1.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'up',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'up',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'up',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'up',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
ax2.set_ylim(500,700); ax2.set_yticks(arange(550,701,50)); ax2.set_xlim([0.7,1.9]); ax2.set_xticks([1,1.6]); ax2.set_title('Bottom Up Task, DOWN Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax2.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'down',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'down',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'down',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'down',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
ax3.set_ylim(500,700); ax3.set_yticks(arange(550,701,50)); ax3.set_xlim([0.7,1.9]); ax3.set_xticks([1,1.6]); ax3.set_title('Top Down Task, UP Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax3.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'up',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'up',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'up',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'up',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
...
if id=='agg':
    ax4.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'down',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'down',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'down',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'down',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'up',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'up',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'up',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'up',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
...
if id=='agg':
    ax2.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'down',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'down',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'down',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'down',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
...
if id=='agg':
    ax3.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'up',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'up',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'up',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'up',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the top down right response
...
if id=='agg':
    ax4.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'down',2)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'down',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'down',3)]],[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'down',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'up',2)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'up',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'up',3)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'up',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
...
if id=='agg':
    ax2.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'down',2)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'down',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'down',3)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'down',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
...
if id=='agg':
    ax3.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'up',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'up',2)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'up',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'up',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'up',3)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'up',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the top down right response
ax4.set_ylim(500,700); ax4.set_yticks(arange(550,701,50)); ax4.set_xlim([0.7,1.9]); ax4.set_xticks([1,1.6]); ax4.set_title('Top Down Task, DOWN Response', size = 18, position = (.5, 0.9));
#ax4.set_ylabel('Response time',size=18); ax4.set_xlabel('Number of matching RESPONSE (including target)',size=18); #,labelpad=40
ax4.set_xticklabels(['3','4']); 
...
if id=='agg':
    ax4.errorbar(1,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'down',2)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'down',2)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'down',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'down',3)],yerr=[[db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'down',3)]],
        [db['%s_UD_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'down',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
