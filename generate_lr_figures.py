...
ax1.set_ylim(400,600); ax1.set_yticks(arange(450,601,50)); ax1.set_xlim([0.7,1.9]); ax1.set_xticks([1,1.6]); ax1.set_title('Bottom Up Task', size = 18, position = (.5, 0.9));
...
ax2.set_ylim(400,600); ax2.set_yticks(arange(450,601,50)); ax2.set_xlim([0.7,1.9]); ax2.set_xticks([1,1.6]); ax2.set_title('Top Down Task', size = 18, position = (.5, 0.9));
...
ax1.set_ylim(400,600); ax1.set_yticks(arange(450,601,50)); ax1.set_xlim([0.7,1.9]); ax1.set_xticks([1,1.6]); ax1.set_title('Target Shape TOP-LEFT', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax1.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,1,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,1,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,1,0)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,1,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,1,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,1,1)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is the top right shape 
ax2.set_ylim(400,600); ax2.set_yticks(arange(450,601,50)); ax2.set_xlim([0.7,1.9]); ax2.set_xticks([1,1.6]); ax2.set_title('Target Shape TOP-RIGHT', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax2.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,2,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,2,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,2,0)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,2,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,2,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,2,1)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the bottom left shape 
ax3.set_ylim(400,600); ax3.set_yticks(arange(450,601,50)); ax3.set_xlim([0.7,1.9]); ax3.set_xticks([1,1.6]); ax3.set_title('Target Shape BOTTOM-LEFT', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax3.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,3,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,3,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,3,0)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,3,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,3,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,3,1)]]],color='black',lw=6.0);
...
ax4.set_ylim(400,600); ax4.set_yticks(arange(450,601,50)); ax4.set_xlim([0.7,1.9]); ax4.set_xticks([1,1.6]); ax4.set_title('Target Shape BOTTOM-RIGHT', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax4.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,4,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,4,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,4,0)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'b',1,4,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,4,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'b',1,4,1)]]],color='black',lw=6.0);
...
if id=='agg':
    ax1.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,1,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,1,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,1,0)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,1,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,1,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,1,1)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is the top right shape 
...
if id=='agg':
    ax2.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,2,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,2,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,2,0)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,2,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,2,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,2,1)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the bottom left shape 
...
if id=='agg':
    ax3.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,3,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,3,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,3,0)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,3,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,3,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,3,1)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the bottom right shape 
...
if id=='agg':
    ax4.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,4,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,4,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,4,0)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_mean_rt'%(id,'t',1,4,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,4,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_rt_bsems'%(id,'t',1,4,1)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,1,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,1,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,1,0)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,1,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,1,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,1,1)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is the top right shape 
...
if id=='agg':
    ax2.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,2,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,2,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,2,0)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,2,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,2,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,2,1)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the bottom left shape 
...
if id=='agg':
    ax3.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,3,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,3,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,3,0)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,3,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,3,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,3,1)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the bottom right shape 
...
if id=='agg':
    ax4.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,4,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,4,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,4,0)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'b',1,4,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,4,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'b',1,4,1)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,1,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,1,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,1,0)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,1,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,1,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,1,1)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is the top right shape 
...
if id=='agg':
    ax2.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,2,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,2,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,2,0)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,2,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,2,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,2,1)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the bottom left shape 
...
if id=='agg':
    ax3.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,3,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,3,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,3,0)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,3,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,3,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,3,1)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the bottom right shape 
...
if id=='agg':
    ax4.errorbar(1,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,4,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,4,0)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,4,0)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc'%(id,'t',1,4,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,4,1)]],[db['%s_LR_%s_%s_targets_%s_targetshape_%s_5thdmatch_pc_bsems'%(id,'t',1,4,1)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
ax1.set_ylim(400,600); ax1.set_yticks(arange(450,601,50)); ax1.set_xlim([0.7,1.9]); ax1.set_xticks([1,1.6]); ax1.set_title('Bottom Up Task, LEFT Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax1.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'left',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'left',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
ax2.set_ylim(400,600); ax2.set_yticks(arange(450,601,50)); ax2.set_xlim([0.7,1.9]); ax2.set_xticks([1,1.6]); ax2.set_title('Bottom Up Task, RIGHT Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax2.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'right',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'b',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'b',1,'right',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
ax3.set_ylim(400,600); ax3.set_yticks(arange(450,601,50)); ax3.set_xlim([0.7,1.9]); ax3.set_xticks([1,1.6]); ax3.set_title('Top Down Task, LEFT Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax3.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'left',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'left',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the top down right response
ax4.set_ylim(400,600); ax4.set_yticks(arange(450,601,50)); ax4.set_xlim([0.7,1.9]); ax4.set_xticks([1,1.6]); ax4.set_title('Top Down Task, LEFT Response', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax4.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'right',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_mean_rt'%(id,'t',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_rt_bsems'%(id,'t',1,'right',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'left',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'left',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
...
if id=='agg':
    ax2.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'right',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'b',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'b',1,'right',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
...
if id=='agg':
    ax3.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'left',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'left',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the top down right response
...
if id=='agg':
    ax4.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'right',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc'%(id,'t',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_pc_bsems'%(id,'t',1,'right',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
if id=='agg':
    ax1.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'left',2)]]],color='black',lw=6.0);
    ax1.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'left',3)]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is bottom up right response
...
if id=='agg':
    ax2.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'right',2)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'b',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'b',1,'right',3)]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#ax3 is the top down left response
...
if id=='agg':
    ax3.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'left',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'left',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'left',2)]]],color='black',lw=6.0);
    ax3.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'left',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'left',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'left',3)]]],color='black',lw=6.0);
ax3.spines['right'].set_visible(False); ax3.spines['top'].set_visible(False);
ax3.spines['bottom'].set_linewidth(2.0); ax3.spines['left'].set_linewidth(2.0);
ax3.yaxis.set_ticks_position('left'); ax3.xaxis.set_ticks_position('bottom');
#ax4 is the top down right response
...
if id=='agg':
    ax4.errorbar(1,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'right',2)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'right',2)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'right',2)]]],color='black',lw=6.0);
    ax4.errorbar(1.6,db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_mean_rt'%(id,'t',1,'right',3)],yerr=[[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'right',3)]],[db['%s_LR_%s_%s_targets_%s_resp_%s_nrmatchdist_5thdnotmatch_rt_bsems'%(id,'t',1,'right',3)]]],color='black',lw=6.0);
ax4.spines['right'].set_visible(False); ax4.spines['top'].set_visible(False);
ax4.spines['bottom'].set_linewidth(2.0); ax4.spines['left'].set_linewidth(2.0);
ax4.yaxis.set_ticks_position('left'); ax4.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
...
ax1.set_ylim(400,600); ax1.set_yticks(arange(450,601,50)); ax1.set_xlim([0.7,2.5]); ax1.set_xticks([1,1.6,2.2]); ax1.set_title('Bottom Up Task', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax2.errorbar(1,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'b','cong_per_cong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','cong_per_cong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','cong_per_cong_resp')]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'b','incong_per_cong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','incong_per_cong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','incong_per_incong_resp')]]],color='black',lw=6.0);
    ax2.errorbar(2.2,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'b','incong_per_incong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','incong_per_incong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'b','incong_per_incong_resp')]]],color='black',lw=6.0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#ax2 is the top down version of the task
ax2.set_ylim(400,600); ax2.set_yticks(arange(450,601,50)); ax2.set_xlim([0.7,2.5]); ax2.set_xticks([1,1.6,2.2]); ax2.set_title('Top Down Task', size = 18, position = (.5, 0.9));
...
if id=='agg':
    ax2.errorbar(1,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'t','cong_per_cong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','cong_per_cong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','cong_per_cong_resp')]]],color='black',lw=6.0);
    ax2.errorbar(1.6,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'t','incong_per_cong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','incong_per_cong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','incong_per_incong_resp')]]],color='black',lw=6.0);
    ax2.errorbar(2.2,db['%s_LR_%s_2_targets_%s_mean_rt'%(id,'t','incong_per_incong_resp')],yerr=[[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','incong_per_incong_resp')]],[db['%s_LR_%s_2_targets_%s_rt_bsems'%(id,'t','incong_per_incong_resp')]]],color='black',lw=6.0);
ax2.spines['right'].set_visible(False); ax2.spines['top'].set_visible(False);
ax2.spines['bottom'].set_linewidth(2.0); ax2.spines['left'].set_linewidth(2.0);
ax2.yaxis.set_ticks_position('left'); ax2.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
