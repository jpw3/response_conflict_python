...
if id=='agg':
    ax2.errorbar(1,['%s_LR_%s_%s_targets_%s_5thdmatch_mean_rt'%(id,'t',1,0)],yerr=[[db['%s_LR_%s_%s_targets_%s_5thdmatch_rt_bsems'%(id,'t',1,0)]],[db['%s_LR_%s_%s_targets_%s_5thdmatch_rt_bsems'%(id,'t',1,0)]]],color='black',lw=6.0);
    ax2.errorbar(1.6,['%s_LR_%s_%s_targets_%s_5thdmatch_mean_rt'%(id,'t',1,1)],yerr=[[db['%s_LR_%s_%s_targets_%s_5thdmatch_rt_bsems'%(id,'t',1,1)]],[db['%s_LR_%s_%s_targets_%s_5thdmatch_rt_bsems'%(id,'t',1,1)]]],color='black',lw=6.0);
