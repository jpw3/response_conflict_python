...
fig , (axuno, axduo) = subplots(2,2,figsize = (12.8,7.64)); fig.suptitle('Top-Down Response Time By Number of Distractors With Matching Shapes For Each Shape,\n Single Target Trials, Left-Right Task, Subject %s'%id, size = 22);
ax1 = axuno[0]; ax2 = axuno[1]; ax3 = axduo[0]; ax4 = axduo[1];
colors=['blue','red'];
#ax1 is the top left shape 
ax1.set_ylim(500,700); ax1.set_yticks(arange(550,701,50)); ax1.set_xlim([0.7,1.9]); ax1.set_xticks([1,1.6]); ax1.set_title('Target Shape TOP-LEFT', size = 18, position = (.5, 0.9));
...
fig , (axuno, axduo) = subplots(2,2,figsize = (12.8,7.64)); fig.suptitle('Bottom-Up Proportion Correct By Number of Distractors With Matching Shapes For Each Shape,\n Single Target Trials, Left-Right Task, Subject %s'%id, size = 22);
ax1 = axuno[0]; ax2 = axuno[1]; ax3 = axduo[0]; ax4 = axduo[1];
colors=['blue','red'];
#ax1 is the top left shape 
